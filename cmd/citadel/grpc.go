...
import (
	...
	vulnerabilitiessvr "github.com/brittonhayes/citadel/gen/grpc/vulnerabilities/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, vulnerabilitiesEndpoints *vulnerabilities.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		vulnerabilitiesServer = vulnerabilitiessvr.New(vulnerabilitiesEndpoints, nil)
	}
	...
	vulnerabilitiespb.RegisterVulnerabilitiesServer(srv, vulnerabilitiesServer)
